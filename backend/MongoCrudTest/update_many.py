...
document_to_update = {"bio": "teste"}

# update
add_to_user = {"$set": {"email": "teste@gmail.com"}}

# pprint documento original
pprint.pprint(users_collection.find_one(document_to_update))

# comando para atualizar
res = users_collection.update_many(document_to_update, add_to_user)

print(f"documentos encontrados: {str(res.matched_count)}")
print(f"documentos atualizados: {str(res.modified_count)}")
pprint.pprint(users_collection.find_one(document_to_update))
